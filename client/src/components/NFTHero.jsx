      ...
      <div className="flex flex-col justify-center items-center mx-auto py-10">
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-white text-5xl font-bold text-center mt-2">
            {/* A.I Arts <br /> */}
            <span className="text-gradient-nft">NFTs</span> Collection
          </h1>
          ...
          <p className="text-white text-sm font-medium text-center">
            NFTs are sort of like digital trading cards, except each is one of a
            kind.
            <br /> Each NFT has its own metadata codes, which are stored on the
            blockchain.
            <br />
            To ensure that they remain unique — and cannot be edited or altered
            in any way.
            <br /> Minting an NFT, or non-fungible token, is publishing a unique
            digital asset on a blockchain
            <br />
            So that it can be bought, sold, and traded.
          </p>

          <ul className="flex flex-row justify-center space-x-2 items-center my-8">
            <a className="bg-white hover:scale-50 transition-all duration-75 delay-75 rounded-full">
